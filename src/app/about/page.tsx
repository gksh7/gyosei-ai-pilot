      ...
      <div className="max-w-[1010px] mx-auto px-6 min-[1042px]:px-0 pt-4 pb-8 sm:pt-8">
        ...
        <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2">
              企業の法務・コンプライアンス実務に携わる中で培った知識をもとに、わかりやすく解説することを心がけています。
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              本サイトの記事は、官公庁・報道機関が公開した情報をAIが収集・整理・解説したものです。情報の正確性には十分注意していますが、最新情報は各公式サイトをご確認ください。
              なお、本サイトの情報は法的助言・専門家の意見の代替となるものではありません。
